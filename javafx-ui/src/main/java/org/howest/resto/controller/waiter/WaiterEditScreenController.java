...
*/
public class WaiterEditScreenController {
    private final WaiterService menuService;

    public WaiterEditScreenController(WaiterService waiterService) {
        this.menuService = waiterService;
    }
}
